...
require_once(include_path(path: 'config/configPaypal.php'));
session_start();
$idUser = $_SESSION['id'];
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/css/page_paiement.css?v=1') ?>">
        ...
        <div class="container">
            <div class="column">
                <div class="A">
                    <div class="info-livraison">
                        ...
                        <a href="<?php echo route('views/profil.php') ?>?sectionProfile=myAccount&note=paiement"><i
            ...
            <div class="C">
                <div class="article-row">
                    ...
                    <a href="<?php echo route('views/cart.php') ?>"><i class="fa-light fa-pen"></i></a>
                </div>
