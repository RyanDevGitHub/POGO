...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/css/cb.css?v=2') ?>">
</head>
...
<body>
    <section>
        ...
        <div class="formulaire">
            ...
            <form class="form" action="<?php echo route('controllers/CheckCbController.php') ?>" method="POST">
                <div class="menu-form">
                    <h1>Paiement</h1>
                </div>
                <div class="input-form">
                    ...
                    <div class="form-group" id="credit_cards">
                        <img src="<?php echo asset('assets/imgs/icons/CB-1.jpg') ?>" id="visa">
