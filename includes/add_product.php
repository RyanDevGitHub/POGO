<form class="form_box" action="<?php echo route('views/profil-admin.php?page=addProduct&action=new&verifier=true') ?>" method="POST"
    ...
    <div class="right">
        ...
        <div class="linkAdd">
            <a class="link" href="<?php echo route('views/profil-admin.php?page=brandManagement') ?>">Ajouter un marque</a>
        </div>
