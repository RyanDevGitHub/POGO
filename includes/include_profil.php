...
<div class="">
    ...
    <form action="<?php echo route('controllers/MoveUserController.php') ?>?mode=admin" name="form_profil" class="form_profil">
        ...
        <?php if (isset($_GET['note']) && $_GET['note'] == "paiement") {
            echo "<div><a class='btnRetourner' href= '" . route('controllers/SearchCartController.php') . "'>Retourner</a></div>";
        }
        ?>
