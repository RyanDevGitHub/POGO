            ...
            ?>
                <tr>
                    ...
                    <td> <span><img width="100px" height="150px"
                                src='<?php echo asset('assets/imgs/img-products/') ?><?php echo $rowPro['image_producte']; ?>'></span> </td>
                    <td> <?php echo $rowPro['price_producte']; ?> € </td>
                    <td> <?php echo $rowPro['title_brand']; ?> </td>
                    <td><a
                            href="<?php echo route('views/profil-admin.php?page=InfosProduit&move_product=active&id_producte=') ?><?php echo $rowPro['id_producte']; ?>&brand=<?php echo $rowPro['title_brand']; ?>"><i
                                class="fa-light fa-pencil"></i></a> </td>
                    <td><a
                            href="<?php echo route('views/profil-admin.php?page=InfosProduit&delete_product=active&id_producte=') ?><?php echo $rowPro['id_producte']; ?>"><i
...
<?php } else if (isset($_GET['move_product'])) {
    include_once(include_path('controllers/MoveProductController.php'));
} else if (isset($_GET['delete_product'])) {
    include_once(include_path('includes/include_delete_product.php'));
}
