<div class="info-client">
    ...
    <form class="form-search" name="form-search" action="<?php echo route('/controllers/SearchInfoClientController.php') ?>">
        <div class="search-info-client">
            ...
            <div class="profil-client">
                <table>
                    ...
                    <tr>
                        ...
                        <th><a href="<?php echo route('views/profil-admin.php?page=InfosClient&info-client=active&modify-profil-client=active') ?>" class="modify-button"><i class="fa fa-cog" aria-hidden="true"></i></a></th>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="modify-profil-client">
            <div class="form_profil">
                ...
                <div>
                    ...
                    <a href="<?php echo asset('controller/MoveUserAdminController.php') ?>?input_delete=adresse" id="adresse" onclick=""><i class="fa-solid fa-eraser"></i></a>
                    <p class="input"><?php print($_SESSION["row"]['0']['adresse']); ?></p>
                </div>
                <div>
                    <p>n° téléphone</p>
                    <a href="<?php echo asset('controller/MoveUserAdminController.php') ?>?input_delete=numero" id="numero"><i class="fa-solid fa-eraser"></i></a>
                    <p class="input"><?php print($_SESSION["row"]['0']['mobile']); ?></p>
                </div>
                <div>
                    <p>Code Postal</p>
                    <a href="<?php echo asset('controller/MoveUserAdminController.php') ?>.?input_delete=code_postal" id="code_postal"><i class="fa-solid fa-eraser"></i></a>
                    <p class="input"><?php print($_SESSION["row"]['0']['code_postal']);  ?></p>
                </div>
                <div>
                    <p>Nom</p>
                    <a href="<?php echo asset('controller/MoveUserAdminController.php') ?>?input_delete=nom" id="nom"><i class="fa-solid fa-eraser"></i></a>
                    <p class="input"><?php print($_SESSION["row"]['0']['last_name']); ?></p>
                </div>
                <div>
                    <p>Prenom</p>
                    <a href="<?php echo asset('controller/MoveUserAdminController.php') ?>?input_delete=prenom" id="prenom"><i class="fa-solid fa-eraser"></i></a>
                ...
                <div>
                    <a href="<?php echo route('views/profil-admin.php?page=InfosClient&info-client=active&container-info-client=active') ?>"><input type="submit" class="send" value="retour"></a>
                </div>
                <?php
                ?>
            </div>
