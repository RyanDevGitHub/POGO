<form class="form_box"
    action="<?php echo route('views/profil-admin.php?page=styleManagement&change_style=active&id_style=') ?><?php echo $_GET['id_style'] ?>"
    ...
    <div class="buttonZone">
        <a class="verify" name="back" href="<?php echo route('views/profil-admin.php?page=styleManagement') ?>">Retour</a>
