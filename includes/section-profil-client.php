    ...
    <div class="profil-section">
            ...
            <form id="profileSectionForm" action="profil.php" method="GET">
                ...
                <ul>
                    ...
                    <li class="buttun_marques_favorites" onclick="selectProfileSection('favoriteBrands')">Marques
                        favorites</li>
                    <li><a href="<?php echo route('controllers/DisconnectController.php') ?>">Se déconnecter</a></li>
        ...
        FIN NAVIGATION-->
                    ...
                    <h2>Bienvenu au page de client</h2></div>";
                            ...
                            include(include_path('includes/include_section_client_infos.php'));
                        } else if ($_GET["sectionProfile"] == "historyCommand") {
                            include(include_path('includes/include_section_history_command.php'));
                        } else  if ($_GET["sectionProfile"] == "favoriteBrands") {
                            include(include_path('includes/include_section_favorite_brands.php'));
                        } else  if ($_GET["sectionProfile"] == "historyCommandDetail") {
                            include(include_path('includes/include_section_history_command_detail.php'));
                        }
                        ?>
                    </div>
        </div>
...
<script src="<?php echo asset('assets/js/profil.js') ?>"></script>