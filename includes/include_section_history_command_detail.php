...
AND sessions = '$id_session';");
         ...
         <?php
            ...
            ?>
             <tr>
                 ...
                 <td> <a href="<?php echo route('views/article-zoom.php?id_product=') ?><?php echo $rowPro['id_producte']; ?>"><img width="100px"
                             height="150px" src='<?php echo asset('assets/imgs/img-products/') ?><?php echo $rowPro['image_producte']; ?>'></a></td>
                 <td> <?php echo $rowPro['total']; ?> € </td>
                 <td> <?php echo $rowPro['quantité']; ?> </td>
                 <td> <?php echo $rowPro['statue']; ?> </td>
                 <td> <?php if (!empty($rowPro['date_commande'])) {
                            echo $rowPro['date_commande'];
                        } ?> </td>
             </tr>
         <?php
            }
 ...
 <div id="btn_div">
     <a id="btnRetourner" href="<?php echo route('views/profil.php?sectionProfile=historyCommand') ?>">Retourner</a>
 </div>