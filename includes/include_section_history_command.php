         ...
         <?php
            ...
            ?>
             <tr>
                 ...
                 <td> <a href="<?php echo route('views/profil.php?sectionProfile=historyCommandDetail&session=') ?><?php echo $rowPro['sessions'] ?>"><img
                             width="100px" height="150px"
                             src='<?php echo asset('assets/imgs/img-products/') ?><?php echo $rowPro['image_producte']; ?>'></a><br>
