        ...
        <div class="information">
            ...
            if (!isset($_GET["page"])) {
                ...
                if ($_GET["page"] == "MonProfil") {
                    include('./include_profil.php');
                } else if ($_GET["page"] == "InfosClient") {
                    include('./include_client_information.php');
                ...
                <br></br>";
                    include_once("./include_product.php");
                    echo "</div>";
                ...
                <br></br>";
                    include_once("./include_add_product.php");
                    echo "</div>";
                    // <!--FIN ADD PRODUCT-->
                ...
                <br></br>";
                    include_once("./include_manage_keywords.php");
                    echo "</div>";
                ...
                <br></br>";
                    include_once("./include_brand_Management.php");
                    echo "</div>";
                    //<!--FIN  ADD MARQUES -->
                ...
                <br></br>";
                    include_once("./include_categorie_Management.php");
                    echo "</div>";
                    //<!--FIN  ADD CATEGORIE -->
                    ...
                    <br></br>";
                    include_once("./include_add_style.php");
                    echo "</div>";
                    //<!--FIN  ADD STYLE -->
                }
            }
