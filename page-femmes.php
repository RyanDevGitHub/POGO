...
<div class="article_section">
    <div class="menu_container">
        ...
        <form id="produitForm" action="page-femmes.php" method="GET">
    ...
    <div class="article-container">
        ...
        $data = $pdo->query("SELECT * FROM productes P
          LEFT JOIN keysword_producte KP
          ON P.id_producte = KP.producte_id
          LEFT JOIN keyswords K
          ON K.id_keys_word = KP.keyswords_id
          WHERE K.keys_word_title = 'Femme' AND $allConditions  ORDER BY id_producte ASC");
