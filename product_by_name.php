...
<body>
    ...
    <section>
        ...
        <div class="contentPro">
            ...
            foreach($productsList as $cle) {
            ?>
            <a href="./page-article-zoom.php?id_product=<?php echo $cle['id']; ?>">
                <div class="article">
                    <img class=img_article src="./res/photo_product/<?php echo $cle['image']; ?>" alt="">
                    <p class="title_article"><?php echo $cle['title']; ?></p>
