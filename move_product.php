<form class="form_box" action="./profil-admin.php?page=InfosProduit&move_product=active&id_producte=<?php echo $_GET['id_producte']; ?>&brand=<?php echo $title_brand; ?>&verifier=true" method="POST" enctype="multipart/form-data">
    ...
    <div class="left">
        ...
        <div id="listKey"></div>
        <script src="./JavaScript/add_product.js?v=2"></script>
