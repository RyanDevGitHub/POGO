...
switch ($_GET['input_delete']) {
    case 'adresse':
        ...
        $pdoStat->execute();
        redirect('controllers/SearchInfoClientController?search-bar=' . $_SESSION['row'][0]['pseudo']);
        break;
    case 'numero':
        include(include_path('database/db.php'));
    ...
    case 'pseudo':
        ...
        break;
    default:
        redirect('views/profil-admin.php?page=InfosClient&info-client=active&modify-profil-client=active');
}
